...
public class PersonResource
{
    ...
    public ModelAndView home()
    {
        ...
        System.out.println(" uff home page through model and view");
        return mv;
    }
    ...
    @GetMapping("/find/{id}")
    public @ResponseBody ResponseEntity<Person> findPersonById(@PathVariable Long id)
    {
    ...
    public @ResponseBody ResponseEntity<?> deletePersonById(@PathVariable Long id)
    {
    ...
    public @ResponseBody ResponseEntity<?> clearDatabase()
    {
